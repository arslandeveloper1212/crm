...
const CustSupportAdminSide = () => {

    return (
        <div className='custom-width-last'>
            <div className='cust-grey-button d-flex justify-content-end ' style={{ visibility: "hidden" }}>

                <h1 className='btn-grey hidden' style={{ margin: '30px 0px' }}>Create Ticket</h1>
            </div>
            ...
            <div className='bg-custdetail' style={{ backgroundColor: '#ececec', borderRadius: '6px', padding: "20px" }}>
                ...
                <div className='row'>
                    <div className='d-flex justify-content-center align-items-center
                     flex-row gap-2'>
                        <button className=' text-black contact-update-en font-given-14'>Resolve</button>
...
export default CustSupportAdminSide;
